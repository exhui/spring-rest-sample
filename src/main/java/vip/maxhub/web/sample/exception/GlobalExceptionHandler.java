...
import static vip.maxhub.web.sample.config.ErrorCodeConfig.PARAMS_RESOLUTION_ERROR;
import static vip.maxhub.web.sample.config.ErrorCodeConfig.SYSTEM_FAIL;
